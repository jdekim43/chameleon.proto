...
public object QueryJvm {
  ...
  public abstract class Server(
    ...
    public open override suspend fun params(request: QueryParamsRequest): QueryParamsResponse =
        throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method injective.tokenfactory.v1beta1.Query.Params is unimplemented"))
    ...
    public open override suspend
        ...
        StatusException(Status.UNIMPLEMENTED.withDescription("Method injective.tokenfactory.v1beta1.Query.DenomAuthorityMetadata is unimplemented"))
    ...
    public open override suspend fun denomsFromCreator(request: QueryDenomsFromCreatorRequest):
        ...
        StatusException(Status.UNIMPLEMENTED.withDescription("Method injective.tokenfactory.v1beta1.Query.DenomsFromCreator is unimplemented"))

    public open override suspend fun tokenfactoryModuleState(request: QueryModuleStateRequest):
        QueryModuleStateResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method injective.tokenfactory.v1beta1.Query.TokenfactoryModuleState is unimplemented"))
    ...
    public override fun bindService(): ServerServiceDefinition =
        ...
        QueryDenomsFromCreatorResponseJvmConverter.convert(denomsFromCreator(QueryDenomsFromCreatorRequestJvmConverter.convert(it)))
    		...
    		.addMethod(
    			ServerCalls.unaryServerMethodDefinition(
    				context = this.context,
    				descriptor = tokenfactoryModuleStateDescriptor,
    				implementation = {
        QueryModuleStateResponseJvmConverter.convert(tokenfactoryModuleState(QueryModuleStateRequestJvmConverter.convert(it)))
        },
    			)
    		)
    		.build()
  ...
  public open class Client(
    ...
    public override suspend fun tokenfactoryModuleState(request: QueryModuleStateRequest):
        QueryModuleStateResponse = tokenfactoryModuleState(request, Metadata())

    public suspend fun tokenfactoryModuleState(request: QueryModuleStateRequest,
        metadata: Metadata): QueryModuleStateResponse =
        QueryModuleStateResponseJvmConverter.convert(
    		ClientCalls.unaryRpc(
    			option.channel, tokenfactoryModuleStateDescriptor,
