...
public final class MsgGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<injective.auction.v1beta1.Tx.MsgUpdateParams,
      injective.auction.v1beta1.Tx.MsgUpdateParamsResponse> getUpdateParamsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateParams",
      requestType = injective.auction.v1beta1.Tx.MsgUpdateParams.class,
      responseType = injective.auction.v1beta1.Tx.MsgUpdateParamsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<injective.auction.v1beta1.Tx.MsgUpdateParams,
      injective.auction.v1beta1.Tx.MsgUpdateParamsResponse> getUpdateParamsMethod() {
    io.grpc.MethodDescriptor<injective.auction.v1beta1.Tx.MsgUpdateParams, injective.auction.v1beta1.Tx.MsgUpdateParamsResponse> getUpdateParamsMethod;
    if ((getUpdateParamsMethod = MsgGrpc.getUpdateParamsMethod) == null) {
      synchronized (MsgGrpc.class) {
        if ((getUpdateParamsMethod = MsgGrpc.getUpdateParamsMethod) == null) {
          MsgGrpc.getUpdateParamsMethod = getUpdateParamsMethod =
              io.grpc.MethodDescriptor.<injective.auction.v1beta1.Tx.MsgUpdateParams, injective.auction.v1beta1.Tx.MsgUpdateParamsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateParams"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  injective.auction.v1beta1.Tx.MsgUpdateParams.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  injective.auction.v1beta1.Tx.MsgUpdateParamsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void bid(injective.auction.v1beta1.Tx.MsgBid request,
    ...
    /**
     */
    default void updateParams(injective.auction.v1beta1.Tx.MsgUpdateParams request,
        io.grpc.stub.StreamObserver<injective.auction.v1beta1.Tx.MsgUpdateParamsResponse> responseObserver) {
  ...
  public static final class MsgStub
    ...
    /**
     */
    public void updateParams(injective.auction.v1beta1.Tx.MsgUpdateParams request,
        io.grpc.stub.StreamObserver<injective.auction.v1beta1.Tx.MsgUpdateParamsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MsgBlockingStub
    ...
    /**
     */
    public injective.auction.v1beta1.Tx.MsgUpdateParamsResponse updateParams(injective.auction.v1beta1.Tx.MsgUpdateParams request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MsgFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<injective.auction.v1beta1.Tx.MsgUpdateParamsResponse> updateParams(
        injective.auction.v1beta1.Tx.MsgUpdateParams request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_UPDATE_PARAMS:
          serviceImpl.updateParams((injective.auction.v1beta1.Tx.MsgUpdateParams) request,
              (io.grpc.stub.StreamObserver<injective.auction.v1beta1.Tx.MsgUpdateParamsResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              injective.auction.v1beta1.Tx.MsgUpdateParams,
              injective.auction.v1beta1.Tx.MsgUpdateParamsResponse>(
