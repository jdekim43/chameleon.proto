...
public data class GenesisState(
  ...
  public val insuranceFunds: List<InsuranceFund>,
  @ProtobufIndex(index = 3)
  public val redemptionSchedule: List<RedemptionSchedule>,
  @ProtobufIndex(index = 4)
  public val nextShareDenomId: ULong,
  @ProtobufIndex(index = 5)
  public val nextRedemptionScheduleId: ULong,
) : ProtobufMessage {
  public companion object {
    public const val TYPE_URL: String = "/injective.insurance.v1beta1.GenesisState"
  }
