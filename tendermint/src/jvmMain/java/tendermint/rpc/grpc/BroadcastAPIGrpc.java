...
public final class BroadcastAPIGrpc {
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void ping(tendermint.rpc.grpc.Types.RequestPing request,
    ...
    /**
     */
    default void broadcastTx(tendermint.rpc.grpc.Types.RequestBroadcastTx request,
  ...
  /**
   * Base class for the server implementation of the service BroadcastAPI.
   */
  public static abstract class BroadcastAPIImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return BroadcastAPIGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service BroadcastAPI.
   */
  public static final class BroadcastAPIStub
      extends io.grpc.stub.AbstractAsyncStub<BroadcastAPIStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service BroadcastAPI.
   */
  public static final class BroadcastAPIBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<BroadcastAPIBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service BroadcastAPI.
   */
  public static final class BroadcastAPIFutureStub
      extends io.grpc.stub.AbstractFutureStub<BroadcastAPIFutureStub> {
