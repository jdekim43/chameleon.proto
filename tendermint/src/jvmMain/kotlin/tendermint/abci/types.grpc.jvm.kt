...
public object ABCIApplicationJvm {
  ...
  private val setOptionDescriptor: MethodDescriptor<Types.RequestSetOption, Types.ResponseSetOption>
  ...
  public abstract class Server(
    ...
    public open override suspend fun setOption(request: RequestSetOption): ResponseSetOption = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method tendermint.abci.ABCIApplication.SetOption is unimplemented"))
    ...
    public override fun bindService(): ServerServiceDefinition =
        ...
        ResponseInfoJvmConverter.convert(info(RequestInfoJvmConverter.convert(it))) },
    		...
    		.addMethod(
    			ServerCalls.unaryServerMethodDefinition(
    				context = this.context,
    				descriptor = setOptionDescriptor,
    				implementation = {
        ResponseSetOptionJvmConverter.convert(setOption(RequestSetOptionJvmConverter.convert(it)))
        },
    			)
    		)
    		.addMethod(
  ...
  public open class Client(
    ...
    public override suspend fun setOption(request: RequestSetOption): ResponseSetOption =
        setOption(request, Metadata())

    public suspend fun setOption(request: RequestSetOption, metadata: Metadata): ResponseSetOption =
        ResponseSetOptionJvmConverter.convert(
    		ClientCalls.unaryRpc(
    			option.channel, setOptionDescriptor,
    			RequestSetOptionJvmConverter.convert(request),
    			option.callOptions, metadata,
    		),
    	)
